...
if __name__ == '__main__':
    ...
    for variation in VARIATIONS:
        ...
        if variation == "20.3-Mint-Y":
            print("    Building 20.3-Mint-Y")
            ...
            os.system("cp cinnamon/20.3-mint-y-thumbnail.png %s" % os.path.join(version_folder, "thumbnail.png"))
            ...
            os.system("cp cinnamon/20.3-mint-y-dark-thumbnail.png %s" % os.path.join(version_folder, "thumbnail.png"))
